      ...
      <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="">
              <img
                src="https://www.linkpicture.com/q/logo_109.png"
                alt="Logo"
                className="h-8 w-40 mr-2 my-3"
              />
              ...
              <div className="flex flex-row justify-center py-4 md:justify-start">
                ...
                <a href="https://github.com/gdgcloudkol" className="text-gray-600">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
            ...
            <div className="text-left">
              <h6 className="uppercase font-semibold mb-4 flex justify-left">
                Contact
              </h6>
        ...
        <div className="flex text-center justify-center items-center p-6 bg-gray-200">
          ...
          <a
            ...
            href="https://gdgcloud.kolkata.dev/"
          >
            GDG Cloud Kolkata
          </a>
        </div>
